...
const AddCategory = () => {
  ...
  const onSubmit = async(e) =>{
    ...
    try {
      ...
      const response = await axios.post( `${import.meta.env.VITE_SERVER_URL}/api/upload/category`,formData)
      ...
      if (response.data.success) {
        ...
        try {
          const addcategoryResponse = await axios.post( `${import.meta.env.VITE_SERVER_URL}/api/addcategory`,category)
